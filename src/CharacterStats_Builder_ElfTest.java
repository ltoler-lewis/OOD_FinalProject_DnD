...
class CharacterStats_Builder_ElfTest {
	...
	void setUp() throws Exception {
		character1_builder = new CharacterStats_Builder_Elf();
	...
	void testSetStrength() {
		assertEquals(character1_builder.strBuff,0,"Strength buff should be 0");
	}
	...
	void testSetDexterity() {
		assertEquals(character1_builder.dexBuff,2,"Dex buff should be 2");
	}
	...
	void testSetConstitution() {
		assertEquals(character1_builder.conBuff,0,"Constitution buff should be 0");
	}
